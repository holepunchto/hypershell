...
program
  ...
  .option('--upload-source <source>', 'Upload a source file from client to target path of the server.') // + it should be one option or just another bin like hypershell-cp
  .option('--upload-target <target>', 'Upload a source file from client to target path of the server.')
